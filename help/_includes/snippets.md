...
Leer wie dit examen zou moeten nemen, welke ervaring wordt geadviseerd, en welke onderwerpen op het examen worden behandeld.

<!--divider-->

## Doelstellingen en toepassingsgebied van examen {#exam-objectives}

Deze sectie verstrekt informatie over de exameninhoud.

<!--divider-->

## Readiness-vragenlijst {#readiness}

Deze online gereedheidsvragenlijst is een zelfevaluatie. Het zal u helpen meten of uw huidige ervaring de geadviseerde minimum kandidaatkwalificaties aanpast.

<!--divider-->

## Hoe wordt gecertificeerd? {#how-to-get-certified-intro}

Deze stappen nemen u door het certificatieproces van begin tot eind.

<!--divider-->

## Uw account maken {#create-your-account}
...
## Materialen onderzoeken {#study-materials-intro}
...
## Plan en betaal examen {#schedule-and-pay}
...
Er zijn bulkkortingen beschikbaar:
...
* Schakel de pop-upblokkering uit voordat u het examen start.
* Controleer uw tijdzone in uw profiel van het Onderzoek door naar het systeem van het Beheer van de Verantwoordelijkheid van de Adobe te gaan, op Programma te klikken/mijn Benoeming van het Examen wijzigen, het selecteren van uw examen, en het gaan naar uw profiel van het Onderzoek.
...
## Uw badges beheren {#manage-your-badges}
