...
# Certificeringsreis voor [!DNL Adobe Target] Expert aan de praktijk
...
* Bepaal op basis van de Adobe Sample Size Calculator hoe variabelen de activiteit beïnvloeden
* Testhypothesen samenstellen op basis van een bepaald scenario en hypothesen identificeren
* Analyseer een testhypothese op basis van een bepaald scenario en identificeer aspecten van een geldige hypothese
...
Sectie 2: Configureren, uitvoeren en beheren (42%)
...
* Pas procedures toe om een A/B testactiviteit tot stand te brengen
...
Deel 3: Analyseren en rapporteren (17%)
...
* Begrijp hoe de Samenvattingsrapporten van Automated Personalization van andere rapporten verschillen
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E406 newtab=true"}[!BADGE examen]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E406 newtab=true"}
