...
* [[!DNL Audience Manager] Productdocumentatie](https://docs.adobe.com/content/help/en/audience-manager/user-guide/aam-home.html){target="_blank"}
...
* Beschrijf beste praktijken voor het gebruiken van SQL functies in Adobe [!DNL Campaign]
* Beschrijf beste praktijken voor het ontwikkelen met JavaScript in Adobe [!DNL Campaign]
