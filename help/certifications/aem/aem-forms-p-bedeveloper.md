...
Leer hoe u een gecertificeerd certificaat kunt worden [!DNL Adobe AEM Forms] Backend Developer Professional.

## Minimale ervaring

U moet ontwikkelaar zijn van formulieren met de volgende status:

* 0-12 maanden ervaring met het AEM Platform
...
Bovendien kunt u beter goed werken in Adobe Managed Services en Adobe Experience Manager as a Cloud Service. Kan Adobe Experience Manager-omgevingen en -infrastructuur instellen.
...
Deel 3: Beheer en probleemoplossing (21%)
...
* Identificeer de eigenschappen van de Pakken van de Dienst in AEM Forms
...
[Zie voorbeeldvragen](https://scorpion.caveon.com/launchpad/ad0-e127-adobe-experience-manager-backend-forms-developer-professional-copy-7s2acv){target="_blank"}
...
[!BADGE examen]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E127 newtab=true"}
