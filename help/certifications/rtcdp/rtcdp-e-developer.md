...
description: Leer hoe te om een verklaard de Deskundige van de Ontwikkelaar van Adobe  [!DNL Real-Time Customer Data Platform]  te worden
...
# Certificatietraject voor Adobe [!DNL Real-Time Customer Data Platform] Developer Expert
